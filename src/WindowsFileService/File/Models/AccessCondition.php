<?php
     ...
     *
     * @category  Microsoft
     * @package   WindowsFileService\File\Models
     * @author    Jan Cinert
    ...
    use WindowsAzure\Blob\Models\AccessCondition as BaseAccessCondition;
     ...
     * @link      https://github.com/jancinert/lnc-azureFileService
     */
    class AccessCondition extends BaseAccessCondition {
        /**
         ...
         *
         * @return \WindowsFileService\File\Models\AccessCondition
         */
         ...
         * Specifying Conditional Headers for File Service Operations</a>.
         *
